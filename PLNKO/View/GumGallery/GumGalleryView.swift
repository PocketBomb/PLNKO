            ...
            ZStack {
                ...
                VStack(spacing: 0) {
                    ...
                    ScrollView(.vertical, showsIndicators: false) {
                                ...
                                ScrollView(.horizontal, showsIndicators: false) {
                                    HStack(spacing: spacing) {
                                        ForEach(0..<characterCount, id: \.self) { index in
                                            let isOpen = index < LevelController.shared.lastLevel-1
                        ...
                        if currentIndex >= LevelController.shared.lastLevel-1 {
                            ...
                            ForEach(0..<4) { row in // 4 строки
                                HStack(spacing: horizontalSpacing) {
                                    ForEach(0..<3) { column in // 3 ячейки в строке
                                        ...
                                        let isOpen = index < LevelController.shared.lastLevel
                        ...
                        .padding(.top, currentIndex >= LevelController.shared.lastLevel-1 ? -28 : 50 ) // Отступ сверху для коллекции
