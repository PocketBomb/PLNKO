...
struct MainView: View {
    ...
    let levels: [(x: CGFloat, y: CGFloat)] = [
        (0.2, 0.92), (0.35, 0.85), (0.62, 0.85),
        (0.85, 0.80), (0.8, 0.7), (0.6, 0.65),
        (0.42, 0.65), (0.2, 0.65), (0.09, 0.57),
        (0.16, 0.45), (0.34, 0.42), (0.38, 0.3)
    ]
...
//                    print("Level \(index + 1) tapped")
                ...
                .position(x: 55,
                          y: geometry.size.height * (1.6/8) + (SizeConverter.isSmallScreen ? 35 : 0))
                
                SpeedView()
                    .position(x: geometry.size.width - 55,
                              y: geometry.size.height * (1.4/8) + (SizeConverter.isSmallScreen ? 35 : 0))
